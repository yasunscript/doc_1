...
<div class="container-fluid"> 
    <div class="col-md-12" style="font-size:1.1em; font-weight:bold;">Unit Usaha Perum Jasatirta II - Realisasi Kerja Operasi</div> 
</div>
</div> 
...
<div class="panels-white4" style="width: 100%; height: 75vh; overflow:hidden; padding:10px;">  
   <form method="post" action="realisasi_operasi/insert.php" name="form"> 
...
$result = mysql_query("select * from realisasi_operasi order by id asc");
...
<td align="center" class="style3">
    <form method="post" action="realisasi_operasi/delete.php" name="form">
