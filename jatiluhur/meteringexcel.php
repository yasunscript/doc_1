...
header('Content-disposition: attachment; filename=HistMet_'.$meteringname.'_'.$periode.'.xls');  
...
<h3 align="center">PLTA Ir. H. Juanda<br>Historical Metering Report<br/></h3>
