...
$query="INSERT INTO rencana_operasi SET id='$id', rkt='$rkt', semester='$semester', tahun='$tahun', bulan='$bulan', plta_juanda_kwh='$plta_juanda_kwh', ipp_curug_kwh='$ipp_curug_kwh', total_kwh='$total_kwh' ";
